...
int[,] Multy2Matrix(int[,] matr1, int[,] matr2) // метод перемножения двух матриц
    {
        int[,] resultMatrix = new int[matr1.GetLength(0),  matr1.GetLength(1)]; // создается результирующая матрица
...
int[,] matrix1 = new int[row, colm]; // обьявляется матрица и ее размерность
int[,] matrix2 = new int[row, colm];
int[,] multyMatrix = new int[row, colm];
matrix1 = FillMatrix(matrix1); // заполнение массива случайными числами и возвращенеие результата
